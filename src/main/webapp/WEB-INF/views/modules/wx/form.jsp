...
<body ontouchstart>
    ...
    <div class="weui_cells weui_cells_form">
      ...
      <div class="weui_cell weui_vcode">
        ...
        <div class="weui_cell_ft">
          <img src="${ctxStatic}/weui/dist/example/images/vcode.jpg">
        </div>
      </div>
    ...
    <div class="weui_cells weui_cells_form">
      ...
      <div class="weui_cell weui_vcode weui_cell_warn">
        ...
        <div class="weui_cell_ft">
          <i class="weui_icon_warn"></i>
          <img src="${pageContext.request.contextPath}/servlet/validateCodeServlet" id="validateCode" onclick="$('.${name}Refresh').click();" class="mid ${name}" style="${imageCssStyle}"/>
        </div>
      </div>
    </div>
  </body>
